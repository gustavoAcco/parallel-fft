...
// configuration step. It creates a namespace called `parallel_fft`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", parallel_fft::cmake::project_name, parallel_fft::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", parallel_fft::cmake::project_version);
      return EXIT_SUCCESS;
    }
